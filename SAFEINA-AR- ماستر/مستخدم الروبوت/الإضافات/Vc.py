...
@safeina.on(admin_cmd(pattern="دعوه للمكالمه(?: |$)(.*)"))
async def _(e):
...
@safeina.on(admin_cmd(pattern="بدء مكالمه(?: |$)(.*)"))
async def _(e):
    try:
...
@safeina.on(admin_cmd(pattern="بلي$"))
...
@safeina.on(admin_cmd(pattern="اذكار$"))
async def ithker(knopis):
...
@safeina.on(admin_cmd(pattern="كت$"))
async def ithker(knopis):
...
@safeina.on(admin_cmd(pattern="خيروك$"))
async def ithker(knopis):
    await knopis.edit(choice(Jepthon_5erok))

    
@safeina.on(admin_cmd(pattern="اذكار عشر$"))    
...
@safeina.on(admin_cmd(pattern="شنو رأيك بهذا$"))
async def ithker(knopis):
...
@safeina.on(admin_cmd(pattern="بوسة$"))
async def ithker(knopis):
