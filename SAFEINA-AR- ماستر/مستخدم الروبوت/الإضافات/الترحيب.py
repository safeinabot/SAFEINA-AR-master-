...
@safeina.on(admin_cmd(pattern=f"{welcome}(?:\s|$)([\s\S]*)"))
...
@safeina.on(admin_cmd(pattern=f"{rmvwelcome}(?:\s|$)([\s\S]*)"))
...
@safeina.on(admin_cmd(pattern=f"{allwelcome}(?:\s|$)([\s\S]*)"))
