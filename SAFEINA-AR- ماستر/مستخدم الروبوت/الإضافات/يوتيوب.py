...
#Translate by  𝑺𝑨𝑭𝑬𝑰𝑵𝑨 𖠢  @S_F_M_L
from ..helpers.utils import _format
from . import safeina, edit_delete, edit_or_reply, hmention, progress, reply_id, ytsearch
...
@safeina.on(admin_cmd(pattern="تيك توك(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
