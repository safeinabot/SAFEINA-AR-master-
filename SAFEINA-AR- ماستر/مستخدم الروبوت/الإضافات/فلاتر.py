...
from userbot import LOGS, bot as Safeina
...
@Safeina.on(admin_cmd(pattern="عكس اللون$", outgoing=True))
@Safeina.on(sudo_cmd(pattern="عكس اللون$", allow_sudo=True))
async def memes(roz):
...
@Safeina.on(admin_cmd(outgoing=True, pattern="فلتر شمسي$"))
async def memes(roz):
    if roz.fwd_from:
        return
    reply = await roz.get_reply_message()
...
@Safeina.on(admin_cmd(outgoing=True, pattern="عكس الصورة$"))
@Safeina.on(sudo_cmd(pattern="عكس الصورة$", allow_sudo=True))
async def memes(roz):
    reply = await roz.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(roz, "**- يجب عليك الرد على ميديا تدعم الامر**")
...
@Safeina.on(admin_cmd(outgoing=True, pattern="قلب الصورة$"))
@Safeina.on(sudo_cmd(pattern="قلب الصورة$", allow_sudo=True))
async def memes(roz):
    reply = await roz.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(roz, "**- يجب عليك الرد على ميديا تدعم الامر**")
...
@Safeina.on(admin_cmd(outgoing=True, pattern="فلتر رمادي$"))
@Safeina.on(sudo_cmd(pattern="فلتر رمادي$", allow_sudo=True))
async def memes(roz):
    reply = await roz.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(roz, "**- يجب عليك الرد على ميديا تدعم الامر**")
...
@Safeina.on(admin_cmd(outgoing=True, pattern="زووم ?(.*)"))
@Safeina.on(sudo_cmd(pattern="زووم ?(.*)", allow_sudo=True))
async def memes(roz):
    reply = await roz.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(roz, "**- يجب عليك الرد على ميديا تدعم الامر**")
...
@Safeina.on(admin_cmd(outgoing=True, pattern="اطار ?(.*)"))
@Safeina.on(sudo_cmd(pattern="اطار ?(.*)", allow_sudo=True))
async def memes(roz):
    reply = await roz.get_reply_message()
    if not (reply and (reply.media)):
        await edit_or_reply(roz, "**- يجب عليك الرد على ميديا تدعم الامر**")
