...
# modified and developed by @S_F_M_L
...
@safeina1n.on(admin_cmd(pattern="ملصق"))
...
@safeina1n.on(admin_cmd(pattern="حزمة"))
async def safeina1npkg(_):
    ...
    await edit_or_reply(
        _, f"**- تم اخذ الحزمه بنجاح ✓ \nالحزمه  → [اضغط هنا](https://t.me/addstickers/{safeina1n_roz.set.short_name})**")
